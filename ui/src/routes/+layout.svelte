<script lang="ts">
  ...
  const routeTitles: { test: (path: string) => boolean; title: string; section?: string }[] = [
    ...
    { test: (path) => path === '/work' || path.startsWith('/work/today'), title: 'Today', section: 'Work' },
    { test: (path) => path.startsWith('/work/live'), title: 'Live', section: 'Work' },
    { test: (path) => path.startsWith('/work/results'), title: 'Results', section: 'Work' },
    ...
    { test: (path) => path.startsWith('/work/task-flows'), title: 'Workflows', section: 'Work' },
    { test: (path) => path.startsWith('/task-flows'), title: 'Workflows', section: 'Work' },
